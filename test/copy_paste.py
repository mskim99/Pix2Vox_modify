...
for i in range (49, 58):
    ...
    # Woman
    '''
    shutil.copy('I:/DK_Data_Process/i_1-2_Slices_Cropped_Xray_png/Axial/f_' + str(i).zfill(3) + '_Axial_cropped_xray.png',
                'I:/Program/Pix2Vox-master/Pix2Vox-master/datasets/KISTI_xray/KISTI_Rendering/00000024/f_' + str(i).zfill(7) + '/rendering/00.png')
    shutil.copy('I:/DK_Data_Process/i_1-2_Slices_Cropped_Xray_png/Coronal/f_' + str(i).zfill(3) + '_Coronal_cropped_xray.png',
                'I:/Program/Pix2Vox-master/Pix2Vox-master/datasets/KISTI_xray/KISTI_Rendering/00000024/f_' + str(i).zfill(7) + '/rendering/01.png')
    shutil.copy('I:/DK_Data_Process/i_1-2_Slices_Cropped_Xray_png/Sagittal/f_' + str(i).zfill(3) + '_Sagittal_cropped_xray.png',
                'I:/Program/Pix2Vox-master/Pix2Vox-master/datasets/KISTI_xray/KISTI_Rendering/00000024/f_' + str(i).zfill(7) + '/rendering/02.png')
    '''

    # Man
    '''
    shutil.copy('I:/DK_Data_Process/i_1-2_Slices_Cropped_Xray_png/Axial/m_' + str(i).zfill(3) + '_Axial_cropped_xray.png',
                'I:/Program/Pix2Vox-master/Pix2Vox-master/datasets/KISTI_xray/KISTI_Rendering/00000024/m_' + str(i).zfill(7) + '/rendering/00.png')
    shutil.copy('I:/DK_Data_Process/i_1-2_Slices_Cropped_Xray_png/Coronal/m_' + str(i).zfill(3) + '_Coronal_cropped_xray.png',
                'I:/Program/Pix2Vox-master/Pix2Vox-master/datasets/KISTI_xray/KISTI_Rendering/00000024/m_' + str(i).zfill(7) + '/rendering/01.png')
    shutil.copy('I:/DK_Data_Process/i_1-2_Slices_Cropped_Xray_png/Sagittal/m_' + str(i).zfill(3) + '_Sagittal_cropped_xray.png',
                'I:/Program/Pix2Vox-master/Pix2Vox-master/datasets/KISTI_xray/KISTI_Rendering/00000024/m_' + str(i).zfill(7) + '/rendering/02.png')
                '''
...
# Rendering Metadata
for i in range (49, 58):
    shutil.copy('I:/renderings.txt', 'I:/Program/Pix2Vox-master/Pix2Vox-master/datasets/KISTI_xray/KISTI_Rendering/00000024/m_' + str(i).zfill(7) + '/rendering/renderings.txt')
